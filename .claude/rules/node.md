...
> Project-specific rules for the XIAOZHI codebase. Extends common rules.
...
- Use `run-with-flags.js` wrapper for all hooks so `XIAOZHI_HOOK_PROFILE` and `XIAOZHI_DISABLED_HOOKS` runtime gating works
