---
description: Navigate XIAOZHI's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /xiaozhi-guide

Use this command as a conversational map of Everything Claude Code. It should help the user discover the right XIAOZHI surface for their task without dumping the entire README or stale catalog counts.
...
/xiaozhi-guide
/xiaozhi-guide setup
/xiaozhi-guide skills
/xiaozhi-guide commands
/xiaozhi-guide hooks
/xiaozhi-guide install
/xiaozhi-guide find: <query>
/xiaozhi-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside XIAOZHI
...
- `/project-init` for stack-aware XIAOZHI onboarding of a target project
