...
The script audits the current working directory by default and auto-detects whether the target is the XIAOZHI repo itself or a consumer project using XIAOZHI.
...
6. Suggested XIAOZHI skills to apply next.
