# plugins/xiaozhi — Codex Repo-Marketplace Plugin Target
...
With this layout, `codex plugin marketplace add xiaozhiapi/XIAOZHI` discovers and
installs `xiaozhi@xiaozhi`. Runtime skill loading from repo marketplaces is still
...
and [xiaozhiapi/XIAOZHI#2128](https://github.com/xiaozhiapi/xiaozhi-cli/issues/2128)).

After install, `codex plugin list` is not enough to prove the runtime can load
the referenced skills and assets. From an XIAOZHI checkout, run:
