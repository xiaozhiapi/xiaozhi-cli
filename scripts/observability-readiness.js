...
function usage() {
  console.log([
    ...
    '',
    'Deterministic XIAOZHI 2.0 observability readiness gate.',
    '',
    'Options:',
...
function buildChecks(rootDir) {
  ...
  const gaRoadmap = readText(rootDir, 'docs/XIAOZHI-2.0-GA-ROADMAP.md');
  ...
  return [
    ...
    },
    {
      ...
      pass: fileExists(rootDir, 'docs/architecture/hud-status-session-control.md')
        ...
        && hudStatusFixture.schema_version === 'xiaozhi.hud-status.v1'
    ...
    },
    {
      ...
      pass: fileExists(rootDir, 'docs/architecture/progress-sync-contract.md')
        ...
        && includesAll(workItems, [
          ...
          'github-issue',
          'sourceClosedAt',
          'xiaozhi-work-items-sync-github'
        ]),
...
function buildReport(rootDir) {
  ...
  return {
    schema_version: 'xiaozhi.observability-readiness.v1',
