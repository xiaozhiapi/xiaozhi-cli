...
/**
 * Resolve the XIAOZHI source root directory.
 *
 * Tries, in order:
 ...
 *   4. Plugin cache auto-detection — scans ~/.claude/plugins/cache/{xiaozhi,everything-claude-code}/
 ...
 *                                    contains XIAOZHI scripts. Default: 'scripts/lib/utils.js'
 * @returns {string} Resolved XIAOZHI root path
 */
