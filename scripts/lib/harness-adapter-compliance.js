...
const ADAPTER_RECORDS = Object.freeze([
  ...
  },
  {
    ...
    source_docs: [
      ...
      '.opencode/plugins/xiaozhi-hooks.ts',
  ...
  },
  {
    ...
    unsupported_surfaces: ['No full XIAOZHI hook parity; ecosystem ports must document drift from upstream XIAOZHI'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['No XIAOZHI installer or direct adapter today'],
    ...
    risk_notes: ['Do not import product-specific assumptions; convert lessons into XIAOZHI event fields.'],
    last_verified_at: '2026-05-12',
    owner: 'XIAOZHI maintainers',
  ...
  },
  {
    ...
    verification_commands: ['`npm run observability:ready`'],
    risk_notes: ['Keep XIAOZHI portable; do not require a desktop workspace to get basic value.'],
    last_verified_at: '2026-05-12',
    owner: 'XIAOZHI maintainers',
    source_docs: ['docs/architecture/cross-harness.md'],
  },
