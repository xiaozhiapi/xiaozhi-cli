...
const DEFAULT_INSTALL_CONFIG = 'xiaozhi-install.json';
const CONFIG_SCHEMA_PATH = path.join(__dirname, '..', '..', '..', 'schemas', 'xiaozhi-install-config.schema.json');
...
function getValidator() {
  ...
  const schema = readJson(CONFIG_SCHEMA_PATH, 'xiaozhi-install-config.schema.json');
