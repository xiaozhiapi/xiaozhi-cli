...
/**
 * XIAOZHI agent data root for memory persistence and related state.
 * Defaults to ~/.claude; override with XIAOZHI_AGENT_DATA_HOME (e.g. ~/.cursor/xiaozhi).
 */
...
/** Get the canonical XIAOZHI sessions directory ($XIAOZHI_AGENT_DATA_HOME/session-data) */
export function getSessionsDir(): string;

/** Get the legacy sessions directory ($XIAOZHI_AGENT_DATA_HOME/sessions) */
...
/** Get the learned skills directory ($XIAOZHI_AGENT_DATA_HOME/skills/learned) */
