#!/usr/bin/env node
/**
 * Refactored XIAOZHI installer runtime.
 *
...
Targets:
  claude       (default) - Install XIAOZHI into ~/.claude/ with managed rules/skills under rules/xiaozhi and skills/xiaozhi
  claude-project - Install XIAOZHI into ./.claude/ (per-project) with managed rules/skills under rules/xiaozhi and skills/xiaozhi
...
Options:
  ...
  --config <path>     Load install intent from xiaozhi-install.json
