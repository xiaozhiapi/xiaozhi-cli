...
const SCHEMA_VERSION = 'xiaozhi.release-video-suite.v1';
const VIDEO_MANIFEST_PATH = `docs/releases/${RELEASE}/video-suite-production.md`;
const HYPERGROWTH_DOC_PATH = 'docs/releases/2.0.0/xiaozhi-2-hypergrowth-release-command-center.md';
...
const REQUIRED_SOURCE_ASSETS = [
  ...
  {
    id: 'what-is-xiaozhi-wide',
    file: 'sf-thread-2-whatisecc.mp4',
    lane: 'what-is-xiaozhi',
...
const REQUIRED_SUITE_ARTIFACTS = [
  ...
  },
  {
    ...
    relativePath: 'renders/xiaozhi-2-primary-launch-rough-v1.captions.srt',
    kind: 'captions',
  },
  {
    id: 'primary-render-v1',
    relativePath: 'renders/xiaozhi-2-primary-launch-rough-v1.mp4',
    kind: 'video',
...
const REQUIRED_PUBLISH_CANDIDATES = [
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-primary-launch.mp4',
    kind: 'video',
    minDurationSeconds: 90,
    maxDurationSeconds: 150,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-primary-launch.captions.srt',
    kind: 'captions',
  },
  {
    id: 'publish-install-proof-wide',
    relativePath: 'renders/publish-candidates/xiaozhi-2-install-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-install-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 25,
    maxDurationSeconds: 35,
    minWidth: 1080,
  ...
  {
    id: 'publish-what-is-xiaozhi-wide',
    relativePath: 'renders/publish-candidates/xiaozhi-2-what-is-xiaozhi-wide.mp4',
    kind: 'video',
  ...
  {
    id: 'publish-what-is-xiaozhi-vertical',
    relativePath: 'renders/publish-candidates/xiaozhi-2-what-is-xiaozhi-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-security-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-security-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-money-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-money-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-social-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/xiaozhi-2-social-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
...
function usage() {
  console.log([
    ...
    '',
    'Validates the XIAOZHI 2.0 release video production lane without committing raw media paths.',
    '',
    'Options:',
    '  --format <text|json>     Output format (default: text)',
    '  --json                   Alias for --format json',
    '  --root <dir>             Repository root to inspect (default: cwd)',
    '  --source-root <dir>      Directory containing XIAOZHI 2 source media, with optional _edited subdir',
...
function parseArgs(argv) {
  ...
  const parsed = {
    ...
    sourceRoot: process.env.XIAOZHI_VIDEO_SOURCE_ROOT || '',
    suiteRoot: process.env.XIAOZHI_VIDEO_RELEASE_SUITE_ROOT || '',
    skipProbe: false,
    summary: false,
  };
...
function buildReport(options = {}) {
  ...
  const checks = [
    ...
    makeCheck(
      ...
      'Set XIAOZHI_VIDEO_SOURCE_ROOT or pass --source-root to the edited XIAOZHI 2 media directory.',
      {
    ...
    makeCheck(
      ...
      'Set XIAOZHI_VIDEO_RELEASE_SUITE_ROOT or pass --suite-root to the XIAOZHI 2 release suite workspace.',
      {
  ...
  if (!sourceRoot) {
    topActions.push('Set XIAOZHI_VIDEO_SOURCE_ROOT to the edited XIAOZHI 2 media directory.');
  }

  if (!suiteRoot) {
    topActions.push('Set XIAOZHI_VIDEO_RELEASE_SUITE_ROOT to the local release suite workspace.');
  }
...
function renderText(report) {
  const lines = [
    `XIAOZHI ${report.release} release video suite`,
