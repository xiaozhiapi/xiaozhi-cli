...
const SCHEMA_VERSION = 'xiaozhi.preview-pack-smoke.v1';
...
const HERMES_BOUNDARY_MARKERS = [
  ...
  'XIAOZHI v2.0.0-rc.1 documents the Hermes surface',
...
function usage() {
  console.log([
    ...
    '',
    'Deterministic smoke gate for the XIAOZHI 2.0 rc.1 preview pack.',
    '',
    'Options:',
