...
const SCHEMA_VERSION = 'xiaozhi.release-approval-gate.v1';
...
const REQUIRED_DECISIONS = [
  ...
  {
    id: 'xiaozhi-tools-billing-language',
    label: 'XIAOZHI Tools billing language',
  },
  {
    id: 'video-upload',
    label: 'Video upload',
...
const REQUIRED_URL_SURFACES = [
  {
    ...
    exampleUrl: 'https://github.com/xiaozhiapi/xiaozhi-cli/releases/tag/v2.0.0-rc.1',
  },
  {
    id: 'npm-rc-package-url',
    label: 'npm rc package URL',
    exampleUrl: 'https://www.npmjs.com/package/xiaozhi-cli/v/2.0.0-rc.1',
  },
  {
    id: 'claude-plugin-tag-url',
    label: 'Claude plugin tag URL',
    exampleUrl: 'https://github.com/xiaozhiapi/xiaozhi-cli/releases/tag/xiaozhi--v2.0.0-rc.1',
  },
  {
    id: 'codex-repo-marketplace-evidence',
    label: 'Codex repo-marketplace evidence',
    exampleUrl: 'https://github.com/xiaozhiapi/xiaozhi-cli/tree/v2.0.0-rc.1/.codex-plugin',
  },
  {
  ...
  {
    id: 'xiaozhi-tools-billing-readiness-url',
    label: 'XIAOZHI Tools billing/readiness URL',
    exampleUrl: 'https://github.com/XIAOZHI-Tools',
  },
];
...
function usage() {
  console.log([
    ...
    '',
    'Final approval gate for XIAOZHI 2.0 rc.1 publication and outbound actions.',
    '',
    'Options:',
