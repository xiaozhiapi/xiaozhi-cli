...
This directory contains XIAOZHI's Qwen CLI install template.
...
The managed install also writes `~/.qwen/xiaozhi-install-state.json` so future XIAOZHI updates and uninstalls can distinguish XIAOZHI-owned files from user-owned Qwen configuration.
