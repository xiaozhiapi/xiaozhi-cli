...
Everything Claude Code (XIAOZHI) プラグインの一般的な問題と解決策。
...
**解決策：**
```bash
# まずXIAOZHIがこのマシンについて認識している情報を確認
...
# 問題がMarketplace/アカウントアクセスの場合、XIAOZHI Toolsのbilling/アカウントリカバリーを別途使用
...
1. **GitHub Issuesを確認**: [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
2. **デバッグログを有効化**:
   ```bash
   export CLAUDE_DEBUG=1
