...
簡潔ガイドと長文ガイドで取り上げたすべてのものはGitHubで利用可能です：`github.com/xiaozhiapi/everything-claude-code`
...
*セッションストレージの例 -> <https://github.com/xiaozhiapi/everything-claude-code/tree/main/examples/sessions>*
...
これらのフックを構築し、リポジトリの`github.com/xiaozhiapi/everything-claude-code/tree/main/hooks/memory-persistence`に置いています。
...
この機能を実現する継続学習スキルを構築しました：`github.com/xiaozhiapi/everything-claude-code/tree/main/skills/continuous-learning`
...
*両ガイドで取り上げたすべてのものはGitHubの[everything-claude-code](https://github.com/xiaozhiapi/everything-claude-code)で利用可能です*
