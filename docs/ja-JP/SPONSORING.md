...
XIAOZHIはClaude Code、Cursor、OpenCode、Codex app/CLIにまたがるオープンソースのエージェントハーネスパフォーマンスシステムとして維持されています。
...
| グロースパートナー | $500/月 | XIAOZHIを積極的に導入するチーム | パイロット特典 + 月次オフィスアワー同期 + ワークフロー統合ガイダンス |
...
- npmダウンロード数（`xiaozhi-cli`、`xiaozhi-agentshield`）
...
- プロジェクトサイト: [https://github.com/xiaozhiapi/xiaozhi-cli](https://github.com/xiaozhiapi/xiaozhi-cli)
