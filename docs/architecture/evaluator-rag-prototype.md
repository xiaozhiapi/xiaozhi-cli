...
XIAOZHI 2.0 needs a self-improving harness loop that can learn from real work
...
- XIAOZHI Tools: route evaluator findings into PR comments, check runs, and Linear
...
## XIAOZHI Tools Mapping

XIAOZHI Tools already flags missing RAG/evaluator evidence for retrieval,
...
Future XIAOZHI Tools work should consume these artifacts as fixture shape before it
...
work should consume these fixtures from XIAOZHI Tools before adding hosted
