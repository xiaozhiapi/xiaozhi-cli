# XIAOZHI Platform Value Loop

XIAOZHI 2.0 is moving from a portable harness layer toward a full operator
...
2. Dedicated XIAOZHI agent: an agent that directly operates over XIAOZHI assets instead
...
```text
XIAOZHI can be used full-stack as a meta-harness + agent + control pane, or
...
- product-specific integrations that can become reusable XIAOZHI skills.
...
External products can build on XIAOZHI without becoming XIAOZHI-branded products. The
contract is:

| Layer | Product contributes | XIAOZHI receives |
| --- | --- | --- |
...
| Case study | A real product workflow that works through XIAOZHI | Distribution, sponsors, Pro interest, consulting demand |
...
Ito is a separate prediction-market basket product. XIAOZHI can still distribute
Ito-shaped skills because the skill workflows are useful without making XIAOZHI
...
The boundary is strict: public XIAOZHI skills do not place trades, do not provide investment advice, do not expose private strategy, and do not merge XIAOZHI Tools billing with Ito billing.

## Value Loop

The platform loop should be explicit:

1. A product team builds a useful workflow as an XIAOZHI skill pack.
...
5. Sanitized patterns become better XIAOZHI skills, evals, gates, or docs.
6. XIAOZHI gains distribution, maintainers, sponsors, Pro interest, and consulting leads.
...
integration becomes another reason to install XIAOZHI, and every serious XIAOZHI user
