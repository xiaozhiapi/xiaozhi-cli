...
Everything Claude Code (XIAOZHI) 插件的常见问题与解决方案。
...
1. **检查 GitHub Issues**：[github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
2. **启用调试日志记录**：
   ```bash
   export CLAUDE_DEBUG=1
