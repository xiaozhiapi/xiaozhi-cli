# XIAOZHI 1.10.1 release announcement draft

XIAOZHI 1.10.1 is the follow-up stabilization release to 1.10.0.
...
- npm/package/release surfaces are aligned and `xiaozhi-cli@1.10.0` is live on npm
...
- GitHub repo: `xiaozhiapi/everything-claude-code`

Those are intentionally different surfaces. The plugin identifier follows Anthropic marketplace rules; the npm package remains `xiaozhi-cli`.
