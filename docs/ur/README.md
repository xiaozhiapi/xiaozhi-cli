...
![XIAOZHI - ایجنٹک کام کے لیے ہارنس-نیٹو آپریٹر سسٹم](../../assets/hero.png)

[![Stars](https://img.shields.io/endpoint?url=https%3A%2F%2Fgithub.com/xiaozhiapi/xiaozhi-cli%2Fbadge%2Fstars&style=flat)](https://github.com/xiaozhiapi/xiaozhi-cli/stargazers)
[![Forks](https://img.shields.io/endpoint?url=https%3A%2F%2Fgithub.com/xiaozhiapi/xiaozhi-cli%2Fbadge%2Fforks&style=flat)](https://github.com/xiaozhiapi/xiaozhi-cli/network/members)
[![Contributors](https://img.shields.io/github/contributors/xiaozhiapi/XIAOZHI?style=flat)](https://github.com/xiaozhiapi/xiaozhi-cli/graphs/contributors)
...
XIAOZHI v2.0.0-rc.1 اس قابل استعمال پرت پر عوامی Hermes آپریٹر کہانی شامل کرتا ہے: [Hermes سیٹ اپ گائیڈ](../../docs/HERMES-SETUP.md) سے شروع کریں، پھر [rc.1 ریلیز نوٹس](../../docs/releases/2.0.0-rc.1/release-notes.md) اور [کراس-ہارنس آرکیٹیکچر](../../docs/architecture/cross-harness.md) دیکھیں۔
...
<td width="25%" align="center">
  <a href="https://github.com/xiaozhiapi/xiaozhi-cli/pricing">
    <strong> XIAOZHI Pro</strong><br />
    <sub>نجی ریپوز · GitHub App · $19/نشست/ماہ</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/xiaozhiapi/xiaozhi-cli">
    <strong> اسپانسر</strong><br />
    <sub>OSS کو فنڈ کریں · $5/ماہ سے</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/xiaozhiapi/xiaozhi-cli/discussions">
...
<sub>**OSS مفت رہتا ہے۔** یہ ریپو ہمیشہ کے لیے MIT لائسنس یافتہ ہے۔ XIAOZHI Pro نجی ریپوز کے لیے ہوسٹڈ GitHub App ہے۔ <a href="https://github.com/xiaozhiapi/xiaozhi-cli">اسپانسرز</a> اور <a href="https://github.com/xiaozhiapi/xiaozhi-cli/pricing">Pro سبسکرائبرز</a> اس کام کو فنڈ کرتے ہیں۔</sub>
...
```bash
# ریپو کلون کریں
git clone https://github.com/xiaozhiapi/xiaozhi-cli.git
cd XIAOZHI

# XIAOZHI-owned نیم اسپیس میں rules کاپی کریں
mkdir -p ~/.claude/rules/xiaozhi
cp -R rules/common ~/.claude/rules/xiaozhi/
cp -R rules/typescript ~/.claude/rules/xiaozhi/  # اپنی زبان منتخب کریں
```
...
/xiaozhi:plan "یوزر تصدیق شامل کریں"
...
| --------------- | ------------------- | ----- |
| نئی feature منصوبہ بنانا | `/xiaozhi:plan "Auth شامل کریں"` | planner |
| سسٹم آرکیٹیکچر ڈیزائن | `/xiaozhi:plan` + architect agent | architect |
...
export XIAOZHI_SESSION_START_MAX_CHARS=4000

# SessionStart سیاق و سباق مکمل طور پر غیر فعال کریں
export XIAOZHI_SESSION_START_CONTEXT=off
```
...
**کیا میں XIAOZHI کو صرف کچھ اجزاء کے ساتھ استعمال کر سکتا ہوں؟**
...
ہاں۔ XIAOZHI کراس-پلیٹ فارم ہے — Claude Code، Cursor، OpenCode، Codex، GitHub Copilot، Gemini، Zed، اور مزید کے ساتھ۔
