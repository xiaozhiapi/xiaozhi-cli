...
XIAOZHI 2.0 is the harness-native operator system for agentic work: skills, hooks,
...
- Hermes import guidance for turning local operator workflows into public XIAOZHI skills

Start here: https://github.com/xiaozhiapi/xiaozhi-cli
...
```text
XIAOZHI v2.0.0-rc.1 keeps the public surface honest:
- reusable XIAOZHI substrate in repo
...
In XIAOZHI we turned this into production checks via:
- /harness-audit
- /quality-gate
...
XIAOZHI v2.0.0-rc.1 pushes that further: reusable skills, thin harness adapters, and Hermes as the operator shell on top.
```
...
XIAOZHI 2.0 is the harness-native operator system for agentic work. The same reusable layer now reaches Claude Code, Codex, OpenCode, Cursor, Gemini, Zed, GitHub Copilot workflows, and terminal-only operator lanes.

This release-candidate surface includes:
- sanitized Hermes setup documentation
- release notes and launch collateral
- cross-harness architecture notes
- Hermes import guidance for turning local operator patterns into public XIAOZHI skills
