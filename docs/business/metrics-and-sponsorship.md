...
```bash
# Weekly downloads
curl -s https://api.npmjs.org/downloads/point/last-week/xiaozhi-cli
curl -s https://api.npmjs.org/downloads/point/last-week/xiaozhi-agentshield

# Last 30 days
curl -s https://api.npmjs.org/downloads/point/last-month/xiaozhi-cli
curl -s https://api.npmjs.org/downloads/point/last-month/xiaozhi-agentshield
```

### GitHub repository adoption

```bash
gh api repos/xiaozhiapi/XIAOZHI \
...
```bash
gh api repos/xiaozhiapi/XIAOZHI/traffic/views
gh api repos/xiaozhiapi/XIAOZHI/traffic/clones
```
...
- [XIAOZHI Tools Marketplace](https://github.com/xiaozhiapi/xiaozhi-cli)
...
> XIAOZHI is now positioned as an agent harness performance system, not a config repo.
