...
XIAOZHI는 다른 하네스를 위한 스킬 서브셋도 제공합니다:
...
1. 먼저 `skills/your-skill-name/` 아래에 일반적인 XIAOZHI 스킬로 추가합니다.
...
- **이슈:** [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
