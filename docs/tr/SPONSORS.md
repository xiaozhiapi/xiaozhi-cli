...
Bu projeye sponsor olan herkese teşekkürler! Desteğiniz XIAOZHI ekosisteminin büyümesini sağlıyor.

## Kurumsal Sponsorlar

*Burada yer almak için [Kurumsal sponsor](https://github.com/xiaozhiapi/xiaozhi-cli) olun*

## İşletme Sponsorları

*Burada yer almak için [İşletme sponsoru](https://github.com/xiaozhiapi/xiaozhi-cli) olun*

## Takım Sponsorları

*Burada yer almak için [Takım sponsoru](https://github.com/xiaozhiapi/xiaozhi-cli) olun*

## Bireysel Sponsorlar

*Burada listelenmek için [sponsor](https://github.com/xiaozhiapi/xiaozhi-cli) olun*
...
- `xiaozhi-cli` ve `xiaozhi-agentshield` için canlı npm kurulum/indirme metrikleri
...
[**Sponsor Olun →**](https://github.com/xiaozhiapi/xiaozhi-cli)
