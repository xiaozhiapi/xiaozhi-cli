...
Everything Claude Code (XIAOZHI) eklentisi için yaygın sorunlar ve çözümler.
...
1. **GitHub Issues'ı Kontrol Edin**: [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
