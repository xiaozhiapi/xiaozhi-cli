...
XIAOZHI, diğer harness'ler için skill alt kümeleri içerir:
...
- **Issue'lar:** [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
