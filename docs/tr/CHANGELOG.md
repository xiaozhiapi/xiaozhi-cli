...
- Hermes operatör hikayesi için genel XIAOZHI 2.0 sürüm adayı yüzeyi eklendi.
- XIAOZHI, Claude Code, Codex, Cursor, OpenCode ve Gemini genelinde yeniden kullanılabilir cross-harness altyapı olarak belgelendi.
...
- Bu bir sürüm adayıdır; tam XIAOZHI 2.0 control-plane yol haritası için GA iddiası değildir.
...
- Bu sürüm bir repo-yüzeyi düzeltmesi ve ekosistem senkronizasyonudur; tam XIAOZHI 2.0 yol haritasının tamamlandığı iddiası değildir.
...
- `everything-claude-code` — Öz-referansiyel XIAOZHI becerisi (#335)
...
- `XIAOZHI_HOOK_PROFILE` ve `XIAOZHI_DISABLED_HOOKS` kontrolleri eklendi.
