...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/xiaozhiapi/everything-claude-code`
...
*Oturum depolama örneği -> <https://github.com/xiaozhiapi/everything-claude-code/tree/main/examples/sessions>*
...
Bu hook'ları oluşturdum ve repo'da `github.com/xiaozhiapi/everything-claude-code/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/xiaozhiapi/everything-claude-code/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [everything-claude-code](https://github.com/xiaozhiapi/everything-claude-code) adresinde mevcuttur*
