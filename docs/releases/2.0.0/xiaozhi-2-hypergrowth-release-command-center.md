# XIAOZHI 2.0 Hypergrowth Release Command Center

Snapshot date: 2026-05-19.

This is the execution map for turning XIAOZHI 2.0 into a complete public release,
...
XIAOZHI should stay useful as free OSS while the managed value accrues around team
...
4. convert sanitized product usage back into XIAOZHI skills, docs, or evidence;
...
through XIAOZHI, while live Itô data and account-specific calls remain gated by
`ITO_API_KEY` and separate from XIAOZHI Tools billing.
...
The video lane should use the existing XIAOZHI video-editing skill plus the
...
Primary source classes already exist in the local XIAOZHI media library. Keep raw
...
| --- | ---: | --- | --- |
| Primary launch video | 90-150s | `longform-full-wide.mp4`, `sf-longform-full.mp4`, `architecture-2-wide.mp4`, `terminal-scan-2-wide.mp4`, `new_site_raw.mp4` | XIAOZHI 2.0 as the operator system |
| Install proof | 30s | README install, terminal scan, quickstart, plugin install | Fewer-click adoption |
| What is XIAOZHI | 45-60s | `sf-thread-2-whatisecc.mp4`, `vertical-2-whatisecc.mp4`, `architecture-2-*` | Product category clarity |
...
- `Use XIAOZHI for skills, hooks, rules, MCP conventions, release gates, and operator workflows.`
...
5. Browser-capture the README, XIAOZHI Tools app, install flow, and relevant proof
   surfaces for b-roll.
