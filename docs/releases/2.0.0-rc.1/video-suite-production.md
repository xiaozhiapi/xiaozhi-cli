...
This is the production contract for the XIAOZHI 2.0 release video suite. It keeps
...
XIAOZHI 2.0 is the harness-native operator system for agentic work.
...
```bash
XIAOZHI_VIDEO_SOURCE_ROOT=/path/to/xiaozhi_2_raws \
XIAOZHI_VIDEO_RELEASE_SUITE_ROOT=/path/to/xiaozhi_2_release_suite \
npm run release:video-suite -- --format json
```

`XIAOZHI_VIDEO_SOURCE_ROOT` should contain proof images and may contain an `_edited/`
subdirectory with edited source clips. `XIAOZHI_VIDEO_RELEASE_SUITE_ROOT` should
...
| `sf-thread-2-whatisecc.mp4` | What is XIAOZHI | category clarity and GitHub App explanation |
...
| --- | ---: | --- | --- |
| Primary launch video | 90-150s | 16:9 | `xiaozhi-2-primary-launch.mp4` |
| Install proof clip | 25-35s | 16:9 and 9:16 | `xiaozhi-2-install-proof-*` |
| What is XIAOZHI clip | 45-60s | 16:9 and 9:16 | `xiaozhi-2-what-is-xiaozhi-*` |
| Security proof clip | 45-60s | 16:9 and 9:16 | `xiaozhi-2-security-proof-*` |
| Money/proof clip | 30-45s | 16:9 and 9:16 | `xiaozhi-2-money-proof-*` |
| Coverage/social proof clip | 30-45s | 16:9 and 9:16 | `xiaozhi-2-social-proof-*` |
...
| --- | --- | ---: | ---: | --- |
| 01 | `sf-longform-full.mp4` | 161.12 | 177.68 | Cleaner opener: XIAOZHI as structured context with skills, commands, agents, hooks, and project setup. |
| 02 | `thread-2-ghapp-money.mp4` | 21.84 | 30.40 | Direct product thesis: agentic harness optimization. |
| 03 | `thread-2-ghapp-money.mp4` | 41.00 | 59.72 | Not another harness; XIAOZHI is the layer and tooling on top of harnesses. |
...
- `renders/xiaozhi-2-primary-launch-rough-v1.captions.srt`
...
| Output | Target |
| --- | --- |
| `xiaozhi-2-primary-launch.mp4` | 90-150s, 1920x1080, audio |
| `xiaozhi-2-primary-launch.captions.srt` | primary captions |
| `xiaozhi-2-install-proof-wide.mp4` | 25-35s, 1920x1080, audio |
| `xiaozhi-2-install-proof-vertical.mp4` | 25-35s, 1080x1920, audio |
| `xiaozhi-2-what-is-xiaozhi-wide.mp4` | 45-60s, 1920x1080, audio |
| `xiaozhi-2-what-is-xiaozhi-vertical.mp4` | 45-60s, 1080x1920, audio |
| `xiaozhi-2-security-proof-wide.mp4` | 45-60s, 1920x1080, audio |
| `xiaozhi-2-security-proof-vertical.mp4` | 45-60s, 1080x1920, audio |
| `xiaozhi-2-money-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `xiaozhi-2-money-proof-vertical.mp4` | 30-45s, 1080x1920, audio |
| `xiaozhi-2-social-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `xiaozhi-2-social-proof-vertical.mp4` | 30-45s, 1080x1920, audio |

## video-use compatible workflow

Use the same production shape as Video Use while keeping the XIAOZHI-specific media
stack intact:
...
- first 10 seconds clearly say what XIAOZHI is;
