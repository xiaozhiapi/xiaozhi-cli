# LinkedIn Draft - XIAOZHI v2.0.0-rc.1

XIAOZHI v2.0.0-rc.1 is ready for final release review as the first release-candidate pass at the 2.0 direction.

The practical shift is simple: XIAOZHI is no longer framed as only a Claude Code plugin or config bundle.
...
- a gated Itô prediction-market skill pack for research, comparison, planning,
  and risk review, with Itô API access kept separate from XIAOZHI Tools and
  approval-based
