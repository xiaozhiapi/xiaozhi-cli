...
This rc.1 note records a public teaser skill pack that connects XIAOZHI's skill
distribution loop with Itô prediction-market workflows while keeping the two
businesses separate.

XIAOZHI remains the open agent-harness substrate and XIAOZHI Tools remains the hosted
GitHub App / Pro surface. Itô remains a separate prediction-market basket
business. The link is distribution: XIAOZHI can ship reusable skills that make
...
1. XIAOZHI users discover useful public prediction-market skills.
...
5. Sanitized patterns can become new XIAOZHI skills.

This sends agent/tooling traffic toward Itô without making XIAOZHI Tools look like
