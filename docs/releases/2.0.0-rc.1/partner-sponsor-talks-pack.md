# XIAOZHI v2.0.0-rc.1 Partner, Sponsor, and Talks Pack
...
| Core revenue lanes | Sponsors, XIAOZHI Tools Pro, consulting, talks | Repeatable growth loop | Approval-gated outbound |
...
```text
XIAOZHI gives teams one reusable layer for skills, hooks, rules, MCP conventions,
...
```text
XIAOZHI 2.0 sponsor slot for cross-harness agent workflows
```
...
I am getting XIAOZHI v2.0.0-rc.1 ready for release review.
...
The sponsor fit is pretty direct: XIAOZHI reaches the exact builders who are
...
Repo: https://github.com/xiaozhiapi/xiaozhi-cli
Sponsor: https://github.com/xiaozhiapi/xiaozhi-cli
Release notes: https://github.com/xiaozhiapi/xiaozhi-cli/blob/main/docs/releases/2.0.0-rc.1/release-notes.md
...
```text
XIAOZHI 2.0 is getting close to rc.1.
...
```text
I am open to a small number of XIAOZHI 2.0 implementation sprints for teams that
are standardizing AI coding workflows.

The useful scope is usually:

1. audit the current harness setup;
2. turn repeated workflows into XIAOZHI skills, hooks, and rules;
...
```text
XIAOZHI started as an open-source workflow layer for Claude Code and is now moving
...
I can show how XIAOZHI uses reusable skills, hooks, MCP conventions, release gates,
...
```text
XIAOZHI v2.0.0-rc.1 preview pack is ready for final release review.

The main point: XIAOZHI 2.0 is a meta-harness for agentic work.
...
- "If your AI coding setup only works in one harness, it is not an operating
  system yet."
- "XIAOZHI 2.0 is the shared layer: skills, hooks, MCPs, release gates, and team
...
- The message claims native payments are ready before XIAOZHI Tools billing readback
  passes.
...
- Repo: <https://github.com/xiaozhiapi/xiaozhi-cli>
- Release notes: <https://github.com/xiaozhiapi/xiaozhi-cli/blob/main/docs/releases/2.0.0-rc.1/release-notes.md>
- Quickstart: <https://github.com/xiaozhiapi/xiaozhi-cli/blob/main/docs/releases/2.0.0-rc.1/quickstart.md>
- Sponsor: <https://github.com/xiaozhiapi/xiaozhi-cli>
- Sponsor tiers: <https://github.com/xiaozhiapi/xiaozhi-cli/blob/main/SPONSORS.md>
- Sponsoring guide: <https://github.com/xiaozhiapi/xiaozhi-cli/blob/main/SPONSORING.md>
