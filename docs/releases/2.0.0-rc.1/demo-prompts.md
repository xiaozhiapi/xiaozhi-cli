# Hermes x XIAOZHI Demo Prompts

## Prompt 1: XIAOZHI Builds XIAOZHI

Use the current XIAOZHI repo and the public release pack at `docs/releases/2.0.0-rc.1/`.

Do 4 things in order:

1. Inspect git status and the current repo diff, then give me a concise XIAOZHI v2.0.0-rc.1 PR or release summary that proves XIAOZHI is being used to build XIAOZHI itself.
...
- one screen capture of Hermes using XIAOZHI to ship XIAOZHI v2.0.0-rc.1
- one setup walkthrough of the Hermes x XIAOZHI workspace
...
Using the XIAOZHI v2.0.0-rc.1 release pack, give me:
