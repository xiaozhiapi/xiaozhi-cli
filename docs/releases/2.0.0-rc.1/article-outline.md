# Article Outline - XIAOZHI v2.0.0-rc.1

## Working Title

Turning XIAOZHI Into a Cross-Harness Operating System
...
- chat, CLI, TUI, cron, and handoffs can sit above the reusable XIAOZHI layer
...
- Claude Code remains the core target, but XIAOZHI now treats Codex, OpenCode,
...
- AgentShield and XIAOZHI Tools work is mirrored into the roadmap so enterprise
