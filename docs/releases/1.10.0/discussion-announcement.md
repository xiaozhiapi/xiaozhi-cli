# XIAOZHI v1.10.0 is live

XIAOZHI just crossed **140K stars**, and the public release surface had drifted too far from the actual repo.
...
That does **not** mean the full XIAOZHI 2.0 roadmap is done.
...
- XIAOZHI 1.x is the battle-tested harness/workflow layer shipping broadly today
- XIAOZHI 2.0 is the alpha control-plane growing on top of it
