...
Todo lo cubierto en las guías breve y extendida está disponible en GitHub: `github.com/xiaozhiapi/everything-claude-code`
...
*Ejemplo de almacenamiento de sesión -> <https://github.com/xiaozhiapi/everything-claude-code/tree/main/examples/sessions>*
...
He construido estos hooks y están en el repositorio en `github.com/xiaozhiapi/everything-claude-code/tree/main/hooks/memory-persistence`
...
He construido una skill de aprendizaje continuo que hace esto: `github.com/xiaozhiapi/everything-claude-code/tree/main/skills/continuous-learning`
...
*Todo lo cubierto en ambas guías está disponible en GitHub en [everything-claude-code](https://github.com/xiaozhiapi/everything-claude-code)*
