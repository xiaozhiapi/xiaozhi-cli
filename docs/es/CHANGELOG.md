...
- Añade la superficie pública del release candidate de XIAOZHI 2.0 para la historia del operador Hermes.
- Documenta XIAOZHI como el sustrato reutilizable cross-harness para Claude Code, Codex, Cursor, OpenCode y Gemini.
...
- Este es un release candidate, no una declaración GA para el roadmap completo del plano de control de XIAOZHI 2.0.
...
- Este lanzamiento es una corrección de la superficie del repo y una sincronización del ecosistema, no una declaración de que el roadmap completo de XIAOZHI 2.0 está completo.
...
- `everything-claude-code` — skill autorreferencial de XIAOZHI (#335)
...
- Añadidos controles `XIAOZHI_HOOK_PROFILE` y `XIAOZHI_DISABLED_HOOKS`.
