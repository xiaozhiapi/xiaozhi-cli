...
gh repo fork xiaozhiapi/everything-claude-code --clone
...
- renombra la skill cuando XIAOZHI cambie o amplíe materialmente la superficie
- prefiere reglas, skills, scripts y MCPs nativos de XIAOZHI sobre nuevas dependencias de terceros por defecto
...
XIAOZHI incluye subconjuntos de skills para otros harnesses:
...
- **Issues:** [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
