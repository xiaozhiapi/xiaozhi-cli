...
XIAOZHI se mantiene como un sistema de rendimiento del harness de agentes de código abierto para Claude Code, Cursor, OpenCode y Codex app/CLI.
...
| Growth Partner | $500/mes | Equipos adoptando activamente XIAOZHI | Beneficios de Pilot + sincronización mensual de office hours + orientación de integración de flujos de trabajo |
...
- Descargas de npm (`xiaozhi-cli`, `xiaozhi-agentshield`)
...
- GitHub Sponsors: [https://github.com/xiaozhiapi/xiaozhi-cli](https://github.com/xiaozhiapi/xiaozhi-cli)
- Sitio del proyecto: [https://github.com/xiaozhiapi/xiaozhi-cli](https://github.com/xiaozhiapi/xiaozhi-cli)
