/**
 * Tests for scripts/hooks/xiaozhi-statusline.js
 *
 * Run with: node tests/hooks/xiaozhi-statusline.test.js
 */
...
const { formatDuration, buildContextBar, readCurrentTask } = require('../../scripts/hooks/xiaozhi-statusline');
...
function makeTempConfig() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'xiaozhi-statusline-test-'));
}

function runTests() {
  console.log('\n=== Testing xiaozhi-statusline.js ===\n');
