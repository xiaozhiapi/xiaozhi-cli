...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'XIAOZHI Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'xiaozhi@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
