...
const DESCRIPTORS = [
  ...
  },
  {
    ...
    fn: () => {
      const state = { schemaVersion: 'xiaozhi.github.coordination.v1', kind: 'epic', status: 'available' };
      const body = [
      ...
      assert.strictEqual(result.schemaVersion, 'xiaozhi.github.coordination.v1');
    },
  },
  {
    group: 'extractCoordinationState',
  ...
  // renderCoordinationState
  {
    ...
    fn: () => {
      const state = {
        schemaVersion: 'xiaozhi.github.coordination.v1', kind: 'epic', status: 'available',
      ...
      assert.ok(rendered.includes('<!-- xiaozhi-coordination:start -->'), 'Missing start marker');
      assert.ok(rendered.includes('<!-- xiaozhi-coordination:end -->'), 'Missing end marker');
  ...
  },
  {
    ...
    fn: () => {
      const state = {
        schemaVersion: 'xiaozhi.github.coordination.v1', kind: 'epic', status: 'claimed',
