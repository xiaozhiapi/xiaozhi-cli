...
Common issues and solutions for Everything Claude Code (XIAOZHI) plugin.
...
**Solutions:**
```bash
# First inspect what XIAOZHI still knows about this machine
...
# If the issue is marketplace/account access, use XIAOZHI Tools billing/account recovery separately; do not use reinstall as a proxy for account recovery
...
1. **Check GitHub Issues**: [github.com/xiaozhiapi/everything-claude-code/issues](https://github.com/xiaozhiapi/everything-claude-code/issues)
