...
Use this playbook when release copy or roadmap text mentions XIAOZHI Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/XIAOZHI-Tools/XIAOZHI-Tools`
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/XIAOZHI-2.0-GA-ROADMAP.md`
- `gh api repos/XIAOZHI-Tools/XIAOZHI-Tools`
- Manual live check of `https://github.com/xiaozhiapi/xiaozhi-cli`
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/XIAOZHI-2.0-GA-ROADMAP.md`
- `git diff --check`
