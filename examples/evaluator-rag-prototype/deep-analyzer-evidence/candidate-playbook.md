...
2. Retrieve the Deep Analyzer Evidence contract from `../XIAOZHI-Tools/README.md`
   and the follow-up logic in `../XIAOZHI-Tools/src/lib/analyzer.ts`.
3. Match the change to maintained corpus or reference evidence:
   - `../XIAOZHI-Tools/src/analyzers/fixtures/deep-analyzer-corpus.ts`
   - `../XIAOZHI-Tools/src/analyzers/deep-analyzer-corpus.test.ts`
   - `../XIAOZHI-Tools/src/lib/analyzer.compare.test.ts`
...
5. Add or update analyzer corpus, expected-output snapshots, fixtures,
   ...
   surface.
6. Run the relevant validation gate from `../XIAOZHI-Tools/`:
