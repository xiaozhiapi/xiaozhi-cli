...
- <https://github.com/xiaozhiapi/xiaozhi-cli/security/advisories/new>

You can also email **<security@github.com/xiaozhiapi/xiaozhi-cli>**.
...
- the `xiaozhiapi/XIAOZHI` repository
- the `xiaozhi-cli` npm package
- XIAOZHI plugin, install, repair, dashboard, hook, rule, skill, MCP, and command surfaces shipped from this repository
- GitHub Actions workflows and release automation in this repository
- the XIAOZHI Tools GitHub App integration points documented by this repository
- AgentShield usage docs when they are embedded here. AgentShield code issues belong in <https://github.com/xiaozhiapi/agentshield>

## Official Distribution Surfaces

Official XIAOZHI surfaces are:

- GitHub repo: <https://github.com/xiaozhiapi/xiaozhi-cli>
- npm package: `xiaozhi-cli`
- GitHub App: <https://github.com/xiaozhiapi/xiaozhi-cli>
- marketplace/plugin slug: `xiaozhi@xiaozhi`
- website: <https://github.com/xiaozhiapi/xiaozhi-cli>

Official AgentShield surface:

- npm package: `xiaozhi-agentshield`
- GitHub repo: <https://github.com/xiaozhiapi/agentshield>

The following packages have been observed using XIAOZHI repository metadata but are **not maintained by XIAOZHI**:

- `@chil_ntl/xiaozhi-cli`
- `xiaozhi-100xprompt-plugin`

Treat any package not listed under official surfaces as unofficial until verified. Do not install packages named `opencode-xiaozhi`, `everything-claude-code`, or other XIAOZHI-like aliases unless this repository explicitly documents them as official.

GitHub dependency graph may also show Go module aliases such as `github.com/xiaozhiapi/xiaozhi` or historical repository paths. XIAOZHI is not currently distributed as a supported Go module.
...
- screenshots, stale line numbers, or reports against `xiaozhiapi/everything-claude-code` that do not reproduce on current `xiaozhiapi/XIAOZHI`
- self-XSS or social engineering with no repository-controlled exploit path
- dependency graph/package metadata confusion without an install path to an official XIAOZHI package
- vulnerabilities in third-party packages unless XIAOZHI pins, installs, or executes them in a way that creates extra impact
...
XIAOZHI treats supply-chain exposure as a first-class security surface.
...
- Package metadata should point at `xiaozhiapi/XIAOZHI`, not historical repo paths.
...
XIAOZHI runs inside agent harnesses that may inject ephemeral client-side system reminders into the model input on every turn. These blocks are not automatically repository-carried payloads.
...
- **AgentShield:** `npx xiaozhi-agentshield scan`
