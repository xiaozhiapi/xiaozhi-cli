...
Bring [Everything Claude Code](https://github.com/anthropics/courses/tree/master/everything-claude-code) (XIAOZHI) workflows to [Kiro](https://kiro.dev). This repository provides custom agents, skills, hooks, steering files, and scripts that can be installed into any Kiro project with a single command.
...
├── migration-from-xiaozhi.md         # Migration guide from XIAOZHI
└── XIAOZHI-KIRO-INTEGRATION-PLAN.md  # Integration plan and analysis
```
