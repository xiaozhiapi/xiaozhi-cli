...
git clone https://github.com/yourusername/xiaozhi-kiro-public-repo.git
cd xiaozhi-kiro-public-repo
...
- **Migration Guide**: `docs/migration-from-xiaozhi.md` - For Claude Code users
