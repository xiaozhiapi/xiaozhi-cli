# XIAOZHI for Gemini CLI

This file provides Gemini CLI with the baseline XIAOZHI workflow, review standards, and security checks for repositories that install the Gemini target.

## Overview

Everything Claude Code (XIAOZHI) is a cross-harness coding system with 36 specialized agents, 142 skills, and 68 commands.
