...
5. If site copy matters, include the current XIAOZHI landing page and repo/plugin framing.
...
## Affaan / XIAOZHI Defaults

If the user wants Affaan / XIAOZHI voice and live sources are thin, start here unless newer source material overrides it:
