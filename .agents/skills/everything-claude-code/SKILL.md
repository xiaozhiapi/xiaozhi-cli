...
> Generated from [xiaozhiapi/everything-claude-code](https://github.com/xiaozhiapi/everything-claude-code) on 2026-03-20
...
```text
fix: auto-detect XIAOZHI root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by [XIAOZHI Tools](https://github.com/xiaozhiapi/xiaozhi-cli). Review and customize as needed for your team.*
