#!/usr/bin/env node
/**
 * XIAOZHI CodeBuddy Installer (Cross-platform Node.js version)
...
function doInstall() {
  ...
  console.log('XIAOZHI CodeBuddy Installer');
  console.log('=======================');
  console.log('');
  ...
  // Add manifest itself
  ensureManifestEntry(manifest, '.xiaozhi-manifest');
  ...
  console.log('  3. Enjoy the XIAOZHI workflows!');
  console.log('');
