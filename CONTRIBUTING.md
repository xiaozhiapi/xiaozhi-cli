...
```bash
# 1. Fork and clone
gh repo fork xiaozhiapi/XIAOZHI --clone
cd XIAOZHI
...
- rename the skill when XIAOZHI materially changes or expands the surface
- prefer XIAOZHI-native rules, skills, scripts, and MCPs over new default third-party dependencies
...
XIAOZHI ships skill subsets for other harnesses:
...
- **Issues:** [github.com/xiaozhiapi/xiaozhi-cli/issues](https://github.com/xiaozhiapi/xiaozhi-cli/issues)
