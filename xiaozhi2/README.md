...
XIAOZHI 2.0 is the layer above individual harness installs.
...
Open issue clusters for the broader roadmap live in the main repo issue tracker under the `xiaozhi-2.0` label.
...
The alpha is missing the higher-level operator surface that defines XIAOZHI 2.0:
