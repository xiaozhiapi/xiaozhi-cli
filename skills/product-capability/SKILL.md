...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an XIAOZHI-native PRD-to-SRS lane instead of vague planning prose.
metadata:
  origin: XIAOZHI
---
...
If useful, point to the next XIAOZHI-native lane:
...
HANDOFF
- what should happen next and which XIAOZHI lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and XIAOZHI 2.0 planning surfaces.
