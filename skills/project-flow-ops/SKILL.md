...
| Port/Rebuild | useful idea, but should be manually re-landed inside XIAOZHI |
...
- External-source features should be rebuilt inside XIAOZHI when they are valuable but not self-contained
...
- "Map GitHub issues into our XIAOZHI 1.x and XIAOZHI 2.0 program lanes"
