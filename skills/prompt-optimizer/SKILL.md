...
description: >-
  Analyze raw prompts, identify intent and gaps, match XIAOZHI components
...
Analyze a draft prompt, critique it, match it to XIAOZHI ecosystem components,
...
- User says "how should I use XIAOZHI for..."
...
- User is asking about XIAOZHI configuration (use `configure-xiaozhi` instead)
...
### Phase 3: XIAOZHI Component Matching

Map intent + scope + tech stack (from Phase 0) to specific XIAOZHI components.
...
### Section 2: Recommended XIAOZHI Components
...
A compact version for experienced XIAOZHI users. Vary by intent type:
...
|-----------|------------------|
| `configure-xiaozhi` | User hasn't set up XIAOZHI yet |
