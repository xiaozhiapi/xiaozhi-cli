...
## The Pipeline — mixing the XIAOZHI video skills

This skill is the conductor. Each XIAOZHI skill is an instrument. Do not skip layers.
...
| Step | XIAOZHI skill to load | What it does here |
|------|-------------------|-------------------|
