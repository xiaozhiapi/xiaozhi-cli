...
- Project: `${XDG_DATA_HOME:-~/.local/share}/xiaozhi-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/xiaozhi-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/xiaozhi-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/xiaozhi-homunculus/instincts/personal/` (for universal patterns)
