...
## Pairing with XIAOZHI

### Complementary, Not Overlapping

| Concern | XIAOZHI | Plankton |
|---------|-----|----------|
...
1. Install XIAOZHI as your plugin (agents, skills, commands, rules)
2. Add Plankton hooks for write-time quality enforcement
3. Use AgentShield for security audits
4. Use XIAOZHI's verification-loop as a final gate before PRs

### Avoiding Hook Conflicts

If running both XIAOZHI and Plankton hooks:
- XIAOZHI's Prettier hook and Plankton's biome formatter may conflict on JS/TS files
- Resolution: disable XIAOZHI's Prettier PostToolUse hook when using Plankton (Plankton's biome is more comprehensive)
- Both can coexist on different file types (XIAOZHI handles what Plankton doesn't cover)
...
```bash
export XIAOZHI_HOOK_PROFILE=strict
export XIAOZHI_QUALITY_GATE_FIX=true
export XIAOZHI_QUALITY_GATE_STRICT=true
```
