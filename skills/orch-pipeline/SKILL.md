...
each phase to an existing XIAOZHI agent or command. This file is that pipeline.
...
> These wrappers **compose** existing XIAOZHI commands rather than replace them:
