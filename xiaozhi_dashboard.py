#!/usr/bin/env python3
"""
XIAOZHI Dashboard - Everything Claude Code GUI
Cross-platform TkInter application for managing XIAOZHI components
"""
...
from scripts.lib.xiaozhi_dashboard_runtime import launch_terminal, maximize_window

logger = logging.getLogger(__name__)

# ============================================================================
# DATA LOADERS - Load XIAOZHI data from the project
# ============================================================================

def get_project_path() -> str:
    """Get the XIAOZHI project path - assumes this script is run from the project dir"""
...
class XiaozhiDashboard(tk.Tk):
    """Main XIAOZHI Dashboard Application"""
    
    def __init__(self):
        super().__init__()
        
        self.project_path = get_project_path()
        self.title("XIAOZHI Dashboard - Everything Claude Code")
        
        maximize_window(self)
        
        try:
            self.icon_image = tk.PhotoImage(file='assets/images/xiaozhi-logo.png')
    ...
    def create_widgets(self):
        ...
        try:
            self.logo_image = tk.PhotoImage(file='assets/images/xiaozhi-logo.png')
        ...
        self.title_label = ttk.Label(header_frame, text="XIAOZHI Dashboard", font=('Open Sans', 18, 'bold'))
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_settings_tab(self):
        ...
        about_text = """XIAOZHI Dashboard v1.0.0
Everything Claude Code GUI

A cross-platform desktop application for 
managing and exploring XIAOZHI components.

Version: 1.10.0
Project: github.com/xiaozhiapi/everything-claude-code"""
