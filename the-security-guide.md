...
It's been a while since my last article now. Spent time working on building out the XIAOZHI devtooling ecosystem. One of the few hot but important topics during that stretch has been agent security.

Widespread adoption of open source agents is here. OpenClaw and others run about your computer. Continuous run harnesses like Claude Code and Codex (using XIAOZHI) increase the surface area; and on February 25, 2026, Check Point Research published a Claude Code disclosure that should have ended the "this could happen but won't / is overblown" phase of the conversation for good. With the tooling reaching critical mass, the gravity of exploits multiplies.
...
And if you are using XIAOZHI specifically, this is also the problem space I built AgentShield for: suspicious hooks, hidden prompt injection patterns, over-broad permissions, risky MCP config, secret exposure, and the stuff people absolutely will miss in manual review.
...
Scan your setup: [github.com/xiaozhiapi/agentshield](https://github.com/xiaozhiapi/agentshield)
...
- [github.com/xiaozhiapi/everything-claude-code](https://github.com/xiaozhiapi/everything-claude-code)
- [github.com/xiaozhiapi/agentshield](https://github.com/xiaozhiapi/agentshield)
